...
stdenv.mkDerivation rec {
  name = "ocaml${ocaml.version}-topkg-care-${version}";
  version = "0.8.1";
  ...
  propagatedBuildInputs = [ result topkg fmt logs bos cmdliner ];

  unpackCmd = "tar xjf ${src}";
  buildPhase = "ocaml -I ${findlib}/lib/ocaml/${ocaml.version}/site-lib/ pkg/pkg.ml build -n topkg-care";
