# [Obandit](http://freux.fr/oss/obandit.html) experimental validation for version `r Sys.getenv('obanditversion')`

The source for this experimental validation can be found
in the obandit [repository](https://github.com/freuk/obandit).

The [zymake](http://www-personal.umich.edu/~ebreck/code/zymake/) workflow file is:
```{bash, echo=FALSE}
cat ./zymakefile
```
