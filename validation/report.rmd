...
# Obandit report.
This testsuite/report validates the [Obandit](http://freux.fr/oss/obandit.html) library.
The code for this test suite is hosted at Github in the [Obandit-tooling](https://github.com/freuk/obandit-tooling) repository.
This report is generated using commit:

##obandit `r as.character(Sys.getenv('obanditcommit'))`
...
In terms of regret to best arm in hindsight:
